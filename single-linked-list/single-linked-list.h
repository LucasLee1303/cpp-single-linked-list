...
public:
    ...
    void PopFront() noexcept {
        ...
        // Удаляет первый элемента непустого списка за время O(1). Не выбрасывает исключений.
        assert(!IsEmpty());

        Node* first_head = head_.next_node->next_node;
        delete head_.next_node;
        head_.next_node = first_head;
        --size_;
    }
    ...
    void Clear() noexcept {
        ...
        {
            Node* clear_head = head_.next_node->next_node;
            delete head_.next_node;
            head_.next_node = clear_head;
        }
        size_ = 0;
    }
